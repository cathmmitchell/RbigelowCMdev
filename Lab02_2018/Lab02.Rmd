...
Last week, we used a csv file that was ready to import into R. More often than not, you'll have to wrangle your data into a form that is readable by R. Today, we'll take a step backwards from where we started last week, and start by creating the csv file to import into R.
...
*ADD IN A NONLINEAR REGRESSION HERE AS A QUICK ASIDE/EXAMPLE? E.G. EXPONENTIAL FIT??*
...
*ADD IN DESCRIPTIONS OF ADJUSTED R-SQUARE, RESIDUAL STANDARD ERROR*
...
# 4. Assignment/Questions/Tasks

1. Explore the relationship between two other variables (perhaps plotting the logarithm of a variable will be useful). Are the variables correlated? How well does a linear regression represent the relationship?
2. Try plotting different variables on a T-S diagram. What does this tell you about the different waters sampled on the cruises?
