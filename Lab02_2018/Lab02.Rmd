...
1. Explore the relationship between two other variables (perhaps plotting the logarithm of a variable will be useful).
Write a couple of sentences describing the relationship - use the following questions to guide your answer:

      a) Are the variables correlated? 

      b) How well does a linear regression represent the relationship?
