...
6. add the station data to a list, labelling it by the station number
4. add the station list data to a master list, labelling it with the unique cruise id.
...
#### Example: plot a section a cruise
...
for (st in stations){
  for (j in 1:100){
    ...
    TEM[j,st] <- mean(stationData[ceiling(stationData$Depth)==j,'Temperature']) 
  }
}
