...
2. Write a couple of paragraphs of a results + discussion section of a paper. Describe the patterns observed in the data from your figures and relate these to the oceanographic processes that could be driving the ecosystem. Try to relate the patterns you observe in your discrete variable to your continuous variable.
